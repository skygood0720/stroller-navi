...
const STROLLER_PRODUCTS: AmazonProduct[] = [
  {
    asin: "B0BWXYZ123", // ← 実際のASINに差し替えてください
    searchKeyword: "コンビ ベビーカー A型 スゴカル",
    name: "コンビ スゴカル compact エッグショック",
    description: "新生児から使えるA型ベビーカー。卵を守る独自クッション「エッグショック」で赤ちゃんの頭部を振動から保護。コンパクトに折りたためて持ち運びしやすい。",
    priceRange: "40,000〜55,000円",
    tags: ["A型", "新生児〜", "コンパクト折りたたみ"],
    emoji: "🚼",
    ageTag: "0ヶ月〜",
    recommend: "初めてのベビーカーとして人気No.1クラス。エレベーターや電車移動が多いママパパに特におすすめです。",
  },
  {
    searchKeyword: "アップリカ ソラリア ベビーカー",
    name: "アップリカ ソラリア",
    description: "超軽量＆コンパクトが魅力のA型ベビーカー。ワンタッチで折りたためてトランクにも収納しやすい。全天候型サンシェードで日差しや雨をしっかりガード。",
    priceRange: "45,000〜60,000円",
    tags: ["A型", "軽量", "全天候対応"],
    emoji: "☀️",
    ageTag: "0ヶ月〜",
    recommend: "サンシェードが大きく日差しの強い夏や、天気が変わりやすい季節のおでかけに重宝します。",
  },
  {
    searchKeyword: "コンビ F2 plus ベビーカー B型",
    name: "コンビ F2 plus（B型軽量ベビーカー）",
    description: "約2.9kgの超軽量B型ベビーカー。腰がすわった生後7ヶ月から使えてコンパクト。電車・バス移動が多いファミリーに最適。",
    priceRange: "12,000〜18,000円",
    tags: ["B型", "超軽量", "コンパクト"],
    emoji: "⚡",
    ageTag: "7ヶ月〜",
    recommend: "2台目や帰省・旅行用に。リーズナブルで軽く、ロッカーにも入るサイズ感が人気です。",
  },
  {
    searchKeyword: "ベビーカー レインカバー 対応 防風",
    name: "ベビーカー用 レインカバー",
    description: "突然の雨から赤ちゃんを守るレインカバー。PVC素材で透明度が高く視界を確保。取り付けかんたんで急な天気の変化にも対応。",
    priceRange: "3,000〜6,000円",
    tags: ["雨の日対策", "防風", "着脱かんたん"],
    emoji: "☔",
    recommend: "梅雨シーズンや旅行に必須アイテム。使わないときはコンパクトに収納できるものを選ぼう。",
  },
  {
    searchKeyword: "ベビーカー フットマフ 冬 防寒",
    name: "ベビーカー用 フットマフ（防寒カバー）",
    description: "秋冬のおでかけに欠かせない防寒フットマフ。ふわふわ素材で赤ちゃんを包み込み、ベビーカーのベルトを通したまま使えるタイプが便利。",
    priceRange: "4,000〜9,000円",
    tags: ["秋冬必須", "防寒", "ベルト対応"],
    emoji: "🧸",
    ageTag: "0ヶ月〜",
    recommend: "北海道・東北のような寒冷地でのおでかけには必需品。ダウン素材のものは保温性が抜群です。",
  },
  {
    searchKeyword: "ベビーカー 収納バッグ 大容量 フック",
    name: "ベビーカー用 収納バッグ＆フックセット",
    description: "ベビーカーのハンドルに取り付けるフック付き収納バッグ。おむつ・着替え・飲み物などをスマートに収納。マグネット式やカラビナ式が人気。",
    priceRange: "1,500〜4,000円",
    tags: ["収納アップ", "ハンドル取付", "大容量"],
    emoji: "🎒",
    recommend: "荷物が多くなりがちなおでかけ時に大活躍。フックはショッピング袋をかけるのにも便利です。",
  },
];

const OUTING_PRODUCTS: AmazonProduct[] = [
  {
    searchKeyword: "エルゴベビー 抱っこ紐 OMNI",
    name: "エルゴベビー OMNI 360",
    description: "新生児から抱っこできる全方向対応の抱っこ紐。前向き・後ろ向き・横向きすべてOK。メッシュ素材で通気性が良く夏でも快適。世界中で愛用される定番ブランド。",
    priceRange: "22,000〜30,000円",
    tags: ["新生児〜", "全方向", "メッシュ素材"],
    emoji: "👶",
    ageTag: "0ヶ月〜",
    recommend: "ベビーカーとの併用で大きな商業施設や混雑した場所もスムーズに移動できます。",
  },
  {
