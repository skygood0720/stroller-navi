...
const FOOTER_LINKS = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/articles/ehon-0sai", label: "0歳におすすめの絵本10選" },
      { href: "/articles/ehon-nemuri", label: "寝かしつけ絵本10選" },
      { href: "/articles/ehon-kotoba", label: "言葉を育てる絵本10選" },
      { href: "/baby-goods/ehon", label: "月齢別おすすめ絵本50冊" },
